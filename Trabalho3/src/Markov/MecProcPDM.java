...
public class MecProcPDM<E> {
	...
	private void iterarUtilidade(){
		...
		do{
			...
			for(E s : modelo.s()){
				...
				if(trans != null){// null significa a posição de um obstaculo
	...
	private Transicao<E> maxTrans(E s, HashMap<E, Double> u){
		...
		//para cada concretizacao valida dos operadoresGerais calcular a sua 
		//utilidade e seleccionar a maxima
	...
	private HashMap<E, Operador<E>> gerarPolitica(){
		...
		//preencher a politica com os operadores que representem os valores em u
		for(E s : modelo.s()){
